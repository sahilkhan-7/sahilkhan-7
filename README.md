...
| **Crime Section Recommendation system** 👮 | Developed an NLP-powered tool to suggest relevant crime sections based on user-provided descriptions. Leveraged text preprocessing, embeddings, and cosine similarity for accurate matching, and built a user-friendly GUI in Tkinter for streamlined access to legal information, including offense details, punishments, and classifications. | [**View Project**](https://github.com/sahilkhan-7/crime-section-recommender) |
...
| **Hand Written Digit Recognition** 🔢 | This project is a deep learning-based solution for recognizing handwritten digits using a CNN trained on the MNIST dataset, achieving 97.5% accuracy. It includes a real-time interactive interface built with Gradio, allowing users to draw digits and receive instant predictions. | [**View Project**](https://github.com/sahilkhan-7/handwritten-digit-recognition) |
| **Attendance Management System** 🅰️ | This system allows users to add student details, mark daily attendance with auto-generated date columns, and view records in a clear tabular format. Data is stored in CSV files, making it easy to manage and access for academic or training purposes. | [**View Project**](https://github.com/sahilkhan-7/Attendance-Mangement-System) |
| **Amazon Sales Analysis**  | Developed an interactive Power BI dashboard and conducted comprehensive analysis of Amazon sales data using Python for preprocessing. Identified key sales trends, revenue distribution, and profit drivers across regions and sales channels, providing actionable insights to optimize business strategies and enhance profitability. | [**View Project**](https://github.com/sahilkhan-7/amazon-sales-analysis) |
| **Black Friday Sales Analysis** | Analyzed Black Friday sales data to identify trends, consumer behavior, and top-performing products. Evaluated online vs. in-store sales, discount strategies, and marketing effectiveness, delivering actionable insights for optimizing sales. | [**View Project**](https://github.com/sahilkhan-7/black-friday-sales-analysis) |
